...
func NewRedirectDecorator(
	...
	return &RedirectDecorator{base: base, redirectStatisticProvider: redirectProvider, tracer: traceProvider.Tracer("internal.link.service.statistic.RedirectStatisticProvider")}
}
